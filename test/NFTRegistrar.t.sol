...
contract NFTRegistrarTest is Test {
    ...
    string private constant TOKEN_URI = "https://metadata.example.com/token/123456789";
    ...
    function testMintWithDomainName() public {
        ...
        assertEq(registrar.ownerOf(TOKEN_ID), user, "User should own the token");
        assertEq(registrar.tokenURI(TOKEN_ID), TOKEN_URI, "Token URI should match");
    ...
    function testGetDomainName() public {
        ...
        // Assertion
        assertEq(retrievedDomainName, DOMAIN_NAME, "Retrieved domain name should match the original");
